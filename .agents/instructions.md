...
本项目使用多 Agent 协作架构，共享资源位于 `.agents/` 目录：

| 资源 | 位置 | 说明 |
|------|------|------|
| 项目指令 | `.agents/instructions.md` | 本文件（单一信源） |
| 技能库 | `.agents/skills/` | 所有 agent 共享的技能 |
| 待办清单 | `TODO.md` | 随手记任务，说"清空 todo"时执行 |
| 经验库 | `.agents/learnings/` | 错误、经验、功能请求 |
| 架构文档 | `.agents/README.md` | 协作架构说明 |
...
1. 如遇到错误/经验，记录到 `.agents/learnings/`
